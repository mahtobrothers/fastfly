package com.abc.fastfly.service;
...
import com.abc.fastfly.base.AppConfig;
import com.abc.fastfly.base.Keyword;
import com.abc.fastfly.db.AccessDatabase;
import com.abc.fastfly.fragment.FileListFragment;
import com.abc.fastfly.util.AppUtils;
import com.abc.fastfly.util.CommunicationBridge;
import com.abc.fastfly.util.CommunicationNotificationHelper;
import com.abc.fastfly.util.DynamicNotification;
import com.abc.fastfly.util.FileUtils;
import com.abc.fastfly.util.HotspotUtils;
import com.abc.fastfly.util.NetworkDeviceLoader;
import com.abc.fastfly.util.NetworkUtils;
import com.abc.fastfly.util.NotificationUtils;
import com.abc.fastfly.util.NsdDiscovery;
import com.abc.fastfly.util.TimeUtils;
import com.abc.fastfly.util.TransferUtils;
import com.genonbeta.CoolSocket.CoolSocket;
import com.genonbeta.CoolSocket.CoolTransfer;
import com.abc.fastfly.R;
import com.abc.fastfly.model.NetworkDevice;
import com.abc.fastfly.model.TextStreamObject;
import com.abc.fastfly.model.TransferGroup;
import com.abc.fastfly.model.TransferInstance;
import com.abc.fastfly.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.abc.fastfly.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.abc.fastfly.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.abc.fastfly.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.abc.fastfly.action.IP";
    public static final String ACTION_END_SESSION = "com.abc.fastfly.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.abc.fastfly.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.abc.fastfly.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.abc.fastfly.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.abc.fastfly.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.abc.fastfly.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.abc.fastfly.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.abc.fastfly.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.abc.fastfly.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.abc.fastfly.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.abc.fastfly.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.abc.fastfly.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.abc.fastfly.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.abc.fastfly.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.abc.fastfly.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.abc.fastfly.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.abc.fastfly.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.abc.fastfly.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.abc.fastfly.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.abc.fastfly.transaction.action.REQUEST_WEBSHARE_STATUS";
